...
def extract_time(data_name, seeds, model_name, res_path='../intermediate/models/',
                        eval_path='eval/'):
    ...
    res_df.to_csv(eval_path+'time-{}-{}.csv'.format(model_name, data_name), index=False)
    print('Result is saved at', eval_path+'time-{}-{}.csv'.format(model_name, data_name))
...
if __name__ == '__main__':
    ...
    if args.run == 'parallel':
        ...
        for data_name in datasets:
            tasks.append([data_name, seeds, args.model, res_path])
